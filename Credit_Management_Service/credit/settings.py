...
SECRET_KEY = 'django-insecure-@p58p=hb%ye-cu$l*&7m1$9#*_(x&0ie*$*m@fut=d24w*$4#s'
...
DATABASES = {
    'default': {
        ...
        'USER': os.getenv('POSTGRES_USER', 'creditdb'),
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'password'),
        'HOST': 'credit-db',  # Use the service name defined in docker-compose.yml
        'PORT': '5432',
    }
}
